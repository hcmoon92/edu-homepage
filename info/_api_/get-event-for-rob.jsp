...
try{
    ...
    String dataSel=request.getParameter("dataSel"); //    "champ"
    ...
    if (dataSel.equals("champ")) {
        ...
        connection = DriverManager.getConnection(connectionUrl+"champtta", userid, password);
        ...
        String sFrom=request.getParameter("from"); //    '1625065200000' -> 20210701 '1627743600000' -> 20210801
        String sTo=request.getParameter("to");
        ...
        connection = DriverManager.getConnection(connectionUrl+"edutta", userid, password);
