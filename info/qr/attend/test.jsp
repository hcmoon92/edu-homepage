...
try{
    ...
    " AND (APPLCNT_ID=(select ESNTL_ID FROM edutta.comtngnrlmber WHERE MBER_ID='truefree') OR MOBLPHON LIKE '%5845%' )";
    ...
    while(resultSet.next()){
        ...
        String detailKey = 'E'+eventId.substring(14)+",A"+applicantId.substring(14)+",@"+emailArray[0]+",T"+telno+",M"+mobileno;
