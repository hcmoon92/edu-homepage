...
<body>
  ...
  <script type="text/javascript">
    ...
    google.charts.setOnLoadCallback(function() { initialize('0', 'orgchart1') });
    google.charts.setOnLoadCallback(function() { initialize('1515358517', 'orgchart2') });
    google.charts.setOnLoadCallback(function() { initialize('358416643', 'orgchart3') });
    ...
    function initialize(gid, divChart) {
      ...
      query.send( function(response) {
        ...
        for (var i = 0; i < num_rows; i++) {
          ...
          data.addRows([[
            { v: role,
              f: "<div class='name'><a href=./orgchart-detail.jsp?gid="+gid+">" + name + "</a></div>" + "<div class='role'>" + role + "</div>"
            }, 
            reportsTo, 
            name]]);
        }
